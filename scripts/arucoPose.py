...
class Aruco:
    def __init__(self):
        ...
        self.camera_calibration_parameters_filename = rospack.get_path('realsense_aruco') + "/calibration/calibration.yaml"
    ...
    def callback(self, data):
        ...
        if ids is not None:
            ...
            for i, id in enumerate(ids):
                ...
                self.pose_data.pose.position.x = transform_translation_x
                self.pose_data.pose.position.y = transform_translation_y
                self.pose_data.pose.position.z = transform_translation_z

                self.pose_data.pose.orientation.x = transform_rotation_x
                self.pose_data.pose.orientation.y = transform_rotation_y
                self.pose_data.pose.orientation.z = transform_rotation_z
                self.pose_data.pose.orientation.w = transform_rotation_w
